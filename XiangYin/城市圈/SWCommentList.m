...
-(void)addSuperView
{
    ...
    self.frame=CGRectMake(0, kScreenHeight, kScreenWidth, kScreenHeight-self.confg.offsetY);
...
{
    //评论标题数量
    _numberLable = [[UILabel alloc]initWithFrame:CGRectMake(kScreenWidth/2 - 50, 0, 100, 40)];
    ...
    //评论内容的表格
    _tableView = [[ListTableView alloc]initWithFrame:CGRectMake(0, 40, kScreenWidth, self.height-40-50) style:UITableViewStylePlain];
    ...
    //评论输入框
    _commentField = [[UITextField alloc]initWithFrame:CGRectMake(30, _tableView.height, kScreenWidth-30, 50)];
...
-(void)show
{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        self.frame=CGRectMake(0, self.confg.offsetY, kScreenWidth, kScreenHeight-self.confg.offsetY);
    }];
}
