...
#define CancelStrImgaeName @"发布主页-关闭"
...
- (void)initUIsize
{
    ...
    bottomView.frame = CGRectMake(0, CGRectGetMaxY(self.bounds) - 100, kW, 100);
...
- (void)closeMenu
{
    ...
    self.disappearButton.hidden = YES;
...
- (void)addTap
{
    ...
    [_backgroundView.contentView addGestureRecognizer:tap];
    _isOpen = true;
}
